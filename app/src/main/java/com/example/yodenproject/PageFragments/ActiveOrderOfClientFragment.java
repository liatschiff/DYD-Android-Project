...
public class ActiveOrderOfClientFragment extends Fragment {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try{
            callBack=(ViewOrderBtnListener)context;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View root=inflater.inflate(R.layout.active_order_for_client,container,false);

        final RecyclerView recyclerView=root.findViewById(R.id.recycler_order_active_client);
