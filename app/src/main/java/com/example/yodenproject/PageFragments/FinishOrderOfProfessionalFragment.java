...
public class FinishOrderOfProfessionalFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View root=inflater.inflate(R.layout.finish_order_for_pro,container,false);

        final RecyclerView recyclerView=root.findViewById(R.id.recycler_order_finish_pro);
        ...
        orderRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                else Toast.makeText(getActivity(), getResources().getString(R.string.no_active_orders), Toast.LENGTH_SHORT).show();
